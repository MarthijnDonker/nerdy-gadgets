...
switch ($SortOnPage) {
    ...
    case "quantity_high_low":{
        $Sort = "QuantityOnHand DESC";
        break;
        // Dit stuk code zorgt dat er gesorteerd kan worden op beschikbaarheid
        // De sort functie sorteert op beschikbaarheid van producten 
        // De desc zorgt ervoor dat de beschikbaarheid wordt gesorteerd van hoog naar laag
    }
    case "name_low_high":
    {
        $Sort = "StockItemName";
    ...
    case "quantity_low_high":{                  
        $Sort = "QuantityOnHand ASC";
        break; 
        // Dit stuk code zorgt dat er gesorteerd kan worden op beschikbaarheid
        // De sort functie sorteert op beschikbaarheid van producten 
        // De asc zorgt ervoor dat de beschikbaarheid wordt gesorteerd van laag naar hoog
    }
    default:
    {
        $Sort = "SellPrice";
    ...
    <form>
        <div id="FilterOptions">
            ...
            <select name="sort" id="sort" onchange="this.form.submit()">>
                ...
                <option value="quantity_high_low" <?php if ($_SESSION['sort'] == "quantity_high_low") {
                    print "selected";
                } ?>> Meeste voorraad
                </option>
                <option value="quantity_low_high" <?php if ($_SESSION['sort'] == "quantity_low_high") {
                    print "selected";
                } ?>> Minste voorraad
                </option>
            </select>
...
<!--                        </form>-->
            ...
            <!-- Er is hier css style gebruikt om de knoppen favorieten en winkelmandje doorzichtig te maken. -->
            <style>
                            #Toevoegen {
                                font-size: 18px;
                                color: #FFFFFF;
